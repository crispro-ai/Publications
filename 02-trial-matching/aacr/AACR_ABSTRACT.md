...
## Background
Clinical trial matching is often driven by keywords, eligibility filters, or single biomarkers. These approaches can miss mechanistically aligned studies and are difficult to audit. We present a mechanism-based trial matching method that ranks trials by alignment to a patient mechanism vector uscurated 7D pathway representations.
...
## Conclusions
This work demonstrates a reproducible, audit-ready mechanism-based ranking peline for trial matching. Outcome validation (enrollment/benefit) is explicitly out of scope for this bundle and is planned as future work.
