...
def main() -> int:
    ...
    md.append("")
    md.append("### 3.4 Behavioral profile on real clinical cohort (n=469)")
    md.append("To evaluate real-world impact, we applied sporadic gates to mutation profiles from 469 TCGA-OV patients.")
    md.append("The system applied a PARP penalty to **98.1%** (460/469) of patients, reflecting a conservative stance when explicit high-DDR/HRD markers are absent in the clinical record.")
    md.append("")
    md.append("**Receipt:** `receipts/real_cohort_behavioral_validation.json`")
    ...
    md.append("- `receipts/real_cohort_behavioral_validation.json`")
