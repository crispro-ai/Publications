...
| IO boost gate (checkpoint drugs) | tmb, msi_status | if TMB≥20 → 1.35x; elif MSI-high → 1.30x; elif TMB≥10 → 1.25x; else 1.0x | Boost checkpoint efficacy when strong tumor biomarkers are present | IO_TMB_BOOST / IO_MSI_BOOST |                                           
...
- IO boost trigger rate (TMB-high OR MSI-high) at TMB ≥ 20: **3.26%**
- PARP rescue rate at HRD ≥ 42: **51.9%**
- Rescue rate range across HRD thresholds tested: **73.3% (HRD≥30)** → **41.1% (HRD≥50)**
