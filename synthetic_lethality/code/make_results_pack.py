...
def main() -> int:
    ...
    dataset_file = Path(report.get("dataset_file") or (bundle_root / "data" / "data/test_cases_100.json"))
    if not dataset_file.is_absolute():
        dataset_file = (bundle_root / dataset_file).resolve()
    if not dataset_file.exists():
        dataset_file = (bundle_root / "data" / "data/test_cases_100.json").resolve()
